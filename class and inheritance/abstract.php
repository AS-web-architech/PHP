<?php
// Create an abstract class called "Shape" that has an abstract method called "calculateArea". Then, create concrete classes for different shapes such as "Rectangle", "Triangle", and "Circle", that implement the "calculateArea" method.
...
// Create an abstract class called "Animal" that has properties for the animal's name, age, and species. Then, create concrete classes for different animals such as "Dog", "Cat", and "Horse", that inherit from the "Animal" class.
...
$animal=new Cat("cat","chimpii","Abyssinian");
$animal->getanimal();
$animal->MakeSound();
echo "<br>";

$an=new Dog("dog","sam","Abyssinian");
$an->getanimal();
$an->MakeSound();
echo "<br>";
$animal=new Cow("cow","momo","Abyssinian");
$animal->getanimal();
$animal->MakeSound();
echo "<br>";
// Create an interface called "Vehicle" that defines methods for getting the vehicle's details, such as "getMake", "getModel", and "getYear". Then, create concrete classes for different vehicles such as "Car", "Truck", and "Motorcycle", that implement the "Vehicle" interface.
...
$pay= new Credit("HABIB BANK","credit");
$pay->pay(12000);
$pay->getpaymentDetails();
echo "<br>";

$pay= new Debit("HABIB BANK","debit");
$pay->pay(10000);
$pay->getpaymentDetails();
echo "<br>";

$pay= new Credit("MEEZAN BANK","paypal");
$pay->pay(15000);
$pay->getpaymentDetails();
echo "<br>";
